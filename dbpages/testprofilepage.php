<!DOCTYPE html>
  <html>
    ...
    <body style="background-color: #f5f8fa;" ng-app="socialworldapp" ng-controller="ProfileController" ng-cloak>
      ...
      <?php require_once('getdbinfo.php');?>
          ...
          <div class="row">
              ...
              <div class="col s12 m7">
                ...
                <div id="profile-info" class="pofile-format">
                  ...
                  <h3 class="truncate profile-name"><?php echo $row['firstname']; ?> <?php echo $row['lastname']; ?></h3>
                  <h5><?php echo $rowP['gender']; ?></h5>
                  <h5><?php echo $rowP['age']; ?></h5>
                  <h5><?php echo $rowP['city']; ?>, <?php echo $rowP['state']; ?></h5>
                  <h5>About Me</h5>
                  <h6><?php echo $rowP['aboutme']; ?></h6>
